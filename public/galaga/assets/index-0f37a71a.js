import { r as renderTitle, c as createKeyboardSystem, A as Audio } from "./index-d0be2068.js";
import { M as MAX_SCORES_TO_SAVE, g as getHighScores, r as resetHighScores } from "./scoring-e97370d4.js";
...
const renderHighScores = ({
  ...
  for (let i2 = 0; i2 < MAX_SCORES_TO_SAVE; i2++) {
    const score = scores[i2];
    const y3 = canvas.height * 0.34 + scoreLineHeight * i2;
    if (score)
      context.fillText(
      ...
      context.fillText("-", canvas.width / 2, y3);
  }
  context.font = `24px Emulogic, monospace`;
